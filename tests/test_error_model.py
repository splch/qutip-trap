...
def test_qubits_can_be_restricted(fx: CircuitFixture, machine: Machine) -> None:
    ...
    default = error_model(Machine(fx.device), qubits=(0,))
    assert default.single_qubit_kinds == ("gpi[0]", "gpi2[0]") and default.machine_hash != machine.hash()
