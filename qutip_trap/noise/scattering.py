"""Photon-scattering collapse operators of a pulse (Raman spin flips, leakage, Rayleigh dephasing and recoil) and the
register levels beyond the qubit pair they populate (PLAN.md Section 6.5).
