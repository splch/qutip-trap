...
module raises ``UncooledModeError`` rather than returning a steady state for it (Section 4.2, first paragraph).
"""
...
def mode_rates(
    ...
    *,
    ...
    """Sum the illuminated ions' contributions to mode m; raise UncooledModeError when no cooling beam projects on it."""
    ...
    return ModeRates(
        ...
        participation_weight=sum(r.participation**2 for r in contributions),
