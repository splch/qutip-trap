...
| `qutip_trap/machine.py`, `options.py` | the executor `Machine` (run, compile, schedule, calibrated, estimate, hash) and the option objects `Physics`, `Numerics`, `Readout` over `SolverOptions` (docs/api_implementation_plan.md 1.3, 1.4) |
