...
v2 (2026-09-04): closure eta*Omega/eps = 1/4 (S = sum sigma convention, concurrence 1) and a realizable
...
def run(nmodes, nmax, T, method):
    ...
    Om = eps / (4 * eta[0][0])  # single-loop MS closure: eta Omega/eps = 1/4 (K=1), S = sum sigma
